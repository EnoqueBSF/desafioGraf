		...
		if ($validacao)
                {
                    ...
                    $sql = "UPDATE pessoa  set nome = ?, cpf = ?, telefone = ?, email = ? WHERE id = ?";
                    $q = $pdo->prepare($sql);
            ...
            <div class="span10 offset1">
                ...
                <form class="form-horizontal" action="atualizar.php?id=<?php echo $id?>" method="post">
                    ...
                    <div class="control-group <?php echo !empty($cpfErro)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="cpf" class="form-control" size="80" type="text" placeholder="CPF" value="<?php echo !empty($cpf)?$cpf:'';?>">
